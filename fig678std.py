...
# 初始条件
h_eval = np.arange(1,55,10)
p_eval = np.arange(1,10,1)
...
fig4 = plt.figure('fig4',figsize=(4,2), dpi=150)
...
fig5 = plt.figure('fig5',figsize=(4,2), dpi=150)
...
fig6 = plt.figure('fig6',figsize=(4,2), dpi=150)
